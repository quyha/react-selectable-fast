...
**Repository forked from [valerybugakov/react-selectable-fast](https://github.com/valerybugakov/react-selectable-fast) version 3.0.0**
...
```sh
npm i -S @quyha/react-selectable-fast
```
